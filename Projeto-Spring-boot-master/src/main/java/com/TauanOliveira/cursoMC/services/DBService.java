...
import com.tauanoliveira.cursoMC.domain.PagamentoComCartao;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        p12.getCategorias().addAll(Arrays.asList(cat6, cat2));
        ...
        p19.getCategorias().addAll(Arrays.asList(cat6));
        p20.getCategorias().addAll(Arrays.asList(cat6));
        p21.getCategorias().addAll(Arrays.asList(cat7));

        categoriaRepository.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
        produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21));
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912724", TipoCliente.PESSOAFISICA, bCrypt.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("977445861", "955662145"));

        Cliente cli2 = new Cliente(null, "Tauan Oliveira Da Silva", "tauan-piraji@gmail.com", "98975518045", TipoCliente.PESSOAFISICA, bCrypt.encode("456"));
        cli2.getTelefones().addAll(Arrays.asList("999755540", "925482145"));
        cli2.addPerfil(Perfil.ADMIN);

        Cliente cli3 = new Cliente(null, "Liciely De Carvalho Chaves", "licy-rainha@gmail.com", "44256885187", TipoCliente.PESSOAFISICA, bCrypt.encode("789"));
